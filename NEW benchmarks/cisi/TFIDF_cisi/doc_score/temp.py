...
def main():
    try:
        ...
        unprocessed_query = open(CURRENT_DIRECTORY+"/CISI.REL",'r').read()
        query_file = open(CURRENT_DIRECTORY+"/newREl.txt",'a')
        
        with open(CURRENT_DIRECTORY+'/CISI.REL') as f:
            lines = ""
            for l in f.readlines():
                summary = l.split()[0].strip() + ' Q0 ' + l.split()[1].strip() + ' ' + '1' #l.split()[2].strip() #Q0 CACM-
